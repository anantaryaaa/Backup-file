...
int main()
{
    ...
    ulang:
        ...
        if(pil==1)
        {
            if(r==6)
            {
                gotoxy(0,5);printf("QUEUE dalam keadaan PENUH, PENYISIPAN DITOLAK!!");
                getchar();
                getchar();
            }
            ...
            printf("Masukkan nilai data: "); scanf("%d",&antrian[r]);
            goto ulang;
        } else if(pil==2)
          {
            if((f==-1)&&(r==-1))
            {
                gotoxy(0,5);printf("QUEUE dalam keadaan KOSONG, PENGHAPUSAN DITOLAK!!");
                getchar();
                getchar();
            }
